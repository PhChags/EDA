...
int main(int argc, char **argv){
	//argc eh a quantidade de argumentos (eh passado automaticamente), e argv são os argumentos que entraram (passa-se como parametro na hora de compilar (./a.out {Nome do arquivo} no gcc do linux)); 
	//Nesse programa passa-se o arquivo de saida como parametro 
	//if(argc != 2) exit(1);
